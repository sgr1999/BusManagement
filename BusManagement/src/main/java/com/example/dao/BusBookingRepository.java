...
public interface BusBookingRepository extends JpaRepository<BusBooking, Long>{
    ...
    @Query("select new com.example.Model.BusBookingModel(bb.bookingDate, bb.bookingNumber, bb.totalSeat, bb.bookingSeat, bb.avaliableSeat, bb.travelingDate) from BusBooking bb")
